...
@section('content')
    <div class="row">
        <div class="col-8">
            ...
            @empty
                {{-- If the site /or the collections don't any post yet, then display this section --}}
            ...
            <div class="row align-items-center mb-5 bg-white shadow-sm rounded-3 py-3">
                    ...
                    <div class="col-auto">
                        <a href="{{route('profile.show',Auth::user()->id)}}">
                            ...
                            @else
                                <i class="fa-solid fa-circle-user text-decoration-none text-dark fw-bold icon-md"></i>
                            @endif
                        </a>
                    </div>
                    <div class="col ps-0">
